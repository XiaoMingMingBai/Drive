/**
 * Open the device driver file in the application and write 2 bytes of data to it,
 * the first byte representing the light and the second byte representing the switch state.
 * 
 * Need the macro definition in the header file.
*/
#include "myled.h"
#include <linux/fs.h>
#include <linux/io.h>
